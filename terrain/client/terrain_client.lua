...
local function pushQuads(quad, indexToQuads, indexToWallQuads, height)
    ...
    local i = rendering.getDrawDepth(quad.centerY, 0)
    ...
    local iwall = rendering.getDrawDepth(quad.centerY, -height)
...
local function pushGreedyQuads(gquad, indexToGreedyQuads, height)
    ...
    local i = rendering.getDrawDepth(gquad.y + gquad.height, height)
